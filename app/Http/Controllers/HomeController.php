...
class HomeController extends Controller
{
    ...
    public function index(Request $request){
        ...
        //seo 
        $meta_desc = "Chúng tôi có đủ tất cả mọi hàng"; 
        ...
        $all_product = DB::table('tbl_product')->where('product_status','0')->orderby(DB::raw('RAND()'))->paginate(15); 
   ...
   public function email($order_code){
     ...
     Mail::send('pages.email',$data,function($message) use ($to_name,$c){
                    ...
                    $message->from($c,'Baller_Store');//send from this mail
                });
